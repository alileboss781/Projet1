...
class Main {
    public static void main(String[] args) {
        ...
        System.out.print("Entrez le critère de recherche (MOINS_ARRETS, PLUS_RAPIDE, MOINS_CHER) : ");
        String critereStr = scanner.nextLine();

        TypeItineraire critere = null;
        try {
            critere = TypeItineraire.valueOf(critereStr.toUpperCase());
        } catch (IllegalArgumentException e) {
            System.out.println("Critère invalide. Utilisation de PLUS_RAPIDE par défaut.");
            critere = TypeItineraire.PLUS_RAPIDE;
        }
        ...
        gestion.rechercherItineraireAvecCriteres(nomDepart, nomArrivee, critere, typePassager);
